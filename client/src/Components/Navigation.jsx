...
export default function NavBar(){
    ...
    return(
        ...
        <>
  {/* component */}
  <div className="bg-gray-100 font-sans w-full h-[70px] m-0">
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between py-4">
          ...
          <div className="flex justify-between items-center gap-4">
            ...
            <div>
                    {/* Add Product Button */}
                    <button onClick={()=> navigate('/watch')} className="bg-white text-black hover:bg-slate-100 px-4 py-2 rounded-lg">Watch</button>
                </div>
          </div>
           </div>
